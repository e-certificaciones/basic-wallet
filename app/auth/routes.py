...
from app.auth.models import validate_username_email, insert_user, validate_username_and_password, user_id_by_username
...
def login():
    ...
    if request.method == "POST":
        ...
        if error:
            ...
            # cuando se haga un login se crea la session
